    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Activities", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DutyTiming = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    StartHour = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    EndHour = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurrenceRule = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ...
                    RecurrenceException = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    StartTimezone = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    EndTimezone = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkStartHour = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    WorkEndHour = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    BreakStartHour = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    BreakEndHour = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    State = table.Column<string>(type: "text", nullable: false),
                    DoctorId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkDays", x => new { x.Day, x.Index });
                    table.ForeignKey(
